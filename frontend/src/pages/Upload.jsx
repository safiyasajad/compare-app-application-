...
export default function UploadPage() {
  ...
  // ✅ Verify password via FastAPI (returns { ok: true/false })
  async function handlePasswordConfirm(password) {
    ...
    try {
      ...
      // If FastAPI is down or CORS blocks, this may fail before JSON
  ...
  function handlePasswordCancel() {
    if (passwordLoading) return; // optional: prevent cancel while checking
    setPasswordOpen(false);
    setPasswordError("");
    resetFlow();
  }
